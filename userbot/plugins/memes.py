...
ABUSE_STRINGS = [
	   ...
	   "`Dhyaat teri maa ki ch*t`",
	   "`Tujhe lund se phasi diya jata agar tere pass hota toh.`",
	   "`Zyada gaand na phulao, nahi toh maa chod denge tumhari hum.`",
	   "`Visshudh chutiye ho tum, chup raho.`",
	   "`You should try licking your own @$$`",
	   "`Ja be Gaandu`",
	   "`Muh Me Lega Bhosdike ?`",
	   "`Kro Gandu giri kam nhi toh Gand Maar lenge tumhari hum😂`",
       "`Suno Lodu Jyda muh na chalao be muh me lawda pel Diyaa jayega`",
       "`Sharam aagyi toh aakhe juka lijiye, lund me dam nhi hai apke toh Shilajit kha lijiye`",
...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("Click [here](https://github.com/StarkGang/fridayUserbot) to open this cool And Best userbot repo .")
